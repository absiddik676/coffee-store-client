...
const AddCoffee = () => {
    ...
    const handelAddCoffee = e => {
        ...
        const newCoffee = {name,chef,Price,taste,Photo,details,category}
    ...
    return (
        <div className='bg-[#F4F3F0]'>
            <h1 className='text-3xl font-semibold py-5'>Add New Coffee</h1>
            ...
            <form onSubmit={handelAddCoffee} className="">
                ...
                <div className='px-20'>
                    <button className='w-full mt-5 border-2 border-[#331A15] py-2 rounded-md mb-10 bg-[#D2B48C] '>Add Coffee</button>
                </div>
            </form>
        </div>
    );
